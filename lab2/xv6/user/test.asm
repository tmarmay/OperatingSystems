...
main(int argc, char *argv[])
{
  ...
  10:	3b2080e7          	jalr	946(ra) # 3be <sem_open>
  sem_open(1,0);
  14:	4581                	li	a1,0
  16:	4505                	li	a0,1
  18:	00000097          	auipc	ra,0x0
  1c:	3a6080e7          	jalr	934(ra) # 3be <sem_open>

  int rc = fork();
  20:	00000097          	auipc	ra,0x0
  24:	2f6080e7          	jalr	758(ra) # 316 <fork>
  
  if (rc == 0){
  28:	e121                	bnez	a0,68 <main+0x68>
    //sem1
    printf("1  \n");
  2a:	00001517          	auipc	a0,0x1
  2e:	82650513          	addi	a0,a0,-2010 # 850 <malloc+0xe4>
  32:	00000097          	auipc	ra,0x0
  36:	67c080e7          	jalr	1660(ra) # 6ae <printf>
    sem_up(0);    
  3a:	4501                	li	a0,0
  3c:	00000097          	auipc	ra,0x0
  40:	38a080e7          	jalr	906(ra) # 3c6 <sem_up>
    sem_down(1);
  44:	4505                	li	a0,1
  46:	00000097          	auipc	ra,0x0
  4a:	388080e7          	jalr	904(ra) # 3ce <sem_down>
    printf("3  \n");
  4e:	00001517          	auipc	a0,0x1
  52:	80a50513          	addi	a0,a0,-2038 # 858 <malloc+0xec>
  56:	00000097          	auipc	ra,0x0
  5a:	658080e7          	jalr	1624(ra) # 6ae <printf>
    //sem0
    sem_down(0);
    printf("2 \n");
    sem_up(1); 
  ...
  64:	2be080e7          	jalr	702(ra) # 31e <exit>
    sem_down(0);
  68:	4501                	li	a0,0
  6a:	00000097          	auipc	ra,0x0
  6e:	364080e7          	jalr	868(ra) # 3ce <sem_down>
    printf("2 \n");
  72:	00000517          	auipc	a0,0x0
  76:	7ee50513          	addi	a0,a0,2030 # 860 <malloc+0xf4>
  7a:	00000097          	auipc	ra,0x0
  7e:	634080e7          	jalr	1588(ra) # 6ae <printf>
    sem_up(1); 
  82:	4505                	li	a0,1
  84:	00000097          	auipc	ra,0x0
  88:	342080e7          	jalr	834(ra) # 3c6 <sem_up>
  8c:	bfc9                	j	5e <main+0x5e>
