...
consoleinit(void)
{
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000482:	76a78793          	addi	a5,a5,1898 # 80020be8 <devsw>
...
main()
{
  ...
  scheduler();        
    ...
    80000f8e:	ef4080e7          	jalr	-268(ra) # 80005e7e <virtio_disk_init>
    userinit();      // first user process
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002550:	5ac90913          	addi	s2,s2,1452 # 80016af8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    800027cc:	b34080e7          	jalr	-1228(ra) # 800062fc <virtio_disk_intr>
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    80002cc2:	ce298993          	addi	s3,s3,-798 # 800169a0 <tickslock>
    80002cc6:	00006497          	auipc	s1,0x6
    80002cca:	c3a48493          	addi	s1,s1,-966 # 80008900 <ticks>
    if(killed(myproc())){
  ...
  return 0;
    ...
    80002d1e:	c8650513          	addi	a0,a0,-890 # 800169a0 <tickslock>
...
sys_uptime(void)
{
  ...
  xticks = ticks;
    ...
    80002d76:	b8e4a483          	lw	s1,-1138(s1) # 80008900 <ticks>
  release(&tickslock);
    80002d7a:	00014517          	auipc	a0,0x14
    80002d7e:	c2650513          	addi	a0,a0,-986 # 800169a0 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002db6:	c0650513          	addi	a0,a0,-1018 # 800169b8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002dc6:	bf678793          	addi	a5,a5,-1034 # 8001e9b8 <bcache+0x8000>
    80002dca:	0001c717          	auipc	a4,0x1c
    80002dce:	e5670713          	addi	a4,a4,-426 # 8001ec20 <bcache+0x8268>
    80002dd2:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dd6:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dda:	00014497          	auipc	s1,0x14
    80002dde:	bf648493          	addi	s1,s1,-1034 # 800169d0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002e3e:	b7e50513          	addi	a0,a0,-1154 # 800169b8 <bcache>
    80002e42:	ffffe097          	auipc	ra,0xffffe
    80002e46:	da8080e7          	jalr	-600(ra) # 80000bea <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002e4a:	0001c497          	auipc	s1,0x1c
    80002e4e:	e264b483          	ld	s1,-474(s1) # 8001ec70 <bcache+0x82b8>
    80002e52:	0001c797          	auipc	a5,0x1c
    80002e56:	dce78793          	addi	a5,a5,-562 # 8001ec20 <bcache+0x8268>
    ...
    80002e7e:	b3e50513          	addi	a0,a0,-1218 # 800169b8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002e9c:	dd04b483          	ld	s1,-560(s1) # 8001ec68 <bcache+0x82b0>
    80002ea0:	0001c797          	auipc	a5,0x1c
    80002ea4:	d8078793          	addi	a5,a5,-640 # 8001ec20 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002edc:	ae050513          	addi	a0,a0,-1312 # 800169b8 <bcache>
  ...
  return b;
    ...
    80002f10:	162080e7          	jalr	354(ra) # 8000606e <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002f3a:	138080e7          	jalr	312(ra) # 8000606e <virtio_disk_rw>
}
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f84:	a3850513          	addi	a0,a0,-1480 # 800169b8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002fac:	a1078793          	addi	a5,a5,-1520 # 8001e9b8 <bcache+0x8000>
    80002fb0:	2b87b703          	ld	a4,696(a5)
    80002fb4:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002fb6:	0001c717          	auipc	a4,0x1c
    80002fba:	c6a70713          	addi	a4,a4,-918 # 8001ec20 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fce:	9ee50513          	addi	a0,a0,-1554 # 800169b8 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80003006:	9b650513          	addi	a0,a0,-1610 # 800169b8 <bcache>
  ...
  release(&bcache.lock);
    ...
    8000301c:	9a050513          	addi	a0,a0,-1632 # 800169b8 <bcache>
...
bunpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    80003058:	96450513          	addi	a0,a0,-1692 # 800169b8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003084:	0147a783          	lw	a5,20(a5) # 8001f094 <sb+0x1c>
...
00000000800030ea <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003108:	f787a783          	lw	a5,-136(a5) # 8001f07c <sb+0x4>
    ...
    80003118:	f64b0b13          	addi	s6,s6,-156 # 8001f078 <sb>
...
000000008000330a <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80003322:	d7a50513          	addi	a0,a0,-646 # 8001f098 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003334:	d8048493          	addi	s1,s1,-640 # 8001f0b0 <itable+0x18>
    80003338:	0001e697          	auipc	a3,0x1e
    8000333c:	80868693          	addi	a3,a3,-2040 # 80020b40 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003368:	d3450513          	addi	a0,a0,-716 # 8001f098 <itable>
  ...
  release(&itable.lock);
    ...
    80003398:	d0450513          	addi	a0,a0,-764 # 8001f098 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800033e6:	c9698993          	addi	s3,s3,-874 # 8001f078 <sb>
  ...
  initlog(dev, &sb);
    ...
    8000341a:	c6258593          	addi	a1,a1,-926 # 8001f078 <sb>
...
0000000080003446 <iinit>:
{
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    80003470:	c5448493          	addi	s1,s1,-940 # 8001f0c0 <itable+0x28>
    80003474:	0001d997          	auipc	s3,0x1d
    80003478:	6dc98993          	addi	s3,s3,1756 # 80020b50 <log+0x10>
...
00000000800034a6 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800034c0:	bc872703          	lw	a4,-1080(a4) # 8001f084 <sb+0xc>
    ...
    800034d4:	ba8a0a13          	addi	s4,s4,-1112 # 8001f078 <sb>
...
0000000080003578 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003590:	b045a583          	lw	a1,-1276(a1) # 8001f090 <sb+0x18>
...
0000000080003604 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80003614:	a8850513          	addi	a0,a0,-1400 # 8001f098 <itable>
  ...
  release(&itable.lock);
    ...
    8000362a:	a7250513          	addi	a0,a0,-1422 # 8001f098 <itable>
...
0000000080003642 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    8000368c:	a085a583          	lw	a1,-1528(a1) # 8001f090 <sb+0x18>
...
00000000800037fc <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    8000380e:	88e50513          	addi	a0,a0,-1906 # 8001f098 <itable>
  ...
  release(&itable.lock);
    ...
    8000382c:	87050513          	addi	a0,a0,-1936 # 8001f098 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003860:	83c50513          	addi	a0,a0,-1988 # 8001f098 <itable>
    ...
    80003896:	80650513          	addi	a0,a0,-2042 # 8001f098 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e32:	d1290913          	addi	s2,s2,-750 # 80020b40 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e56:	d1e78793          	addi	a5,a5,-738 # 80020b70 <log+0x30>
    ...
    80003e6a:	d0e60613          	addi	a2,a2,-754 # 80020b74 <log+0x34>
...
0000000080003e9c <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003ea0:	cd07a783          	lw	a5,-816(a5) # 80020b6c <log+0x2c>
    80003ea4:	0af05d63          	blez	a5,80003f5e <install_trans+0xc2>
{
    ...
    80003ec2:	cb2a8a93          	addi	s5,s5,-846 # 80020b70 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ec6:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003ec8:	0001d997          	auipc	s3,0x1d
    80003ecc:	c7898993          	addi	s3,s3,-904 # 80020b40 <log>
...
0000000080003f60 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003f76:	bce48493          	addi	s1,s1,-1074 # 80020b40 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003fb6:	bbe68693          	addi	a3,a3,-1090 # 80020b70 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003fea:	b807a323          	sw	zero,-1146(a5) # 80020b6c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000406a:	ada50513          	addi	a0,a0,-1318 # 80020b40 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000409a:	aaa48493          	addi	s1,s1,-1366 # 80020b40 <log>
  ...
  if(log.outstanding == 0){
    ...
    800040be:	a8648493          	addi	s1,s1,-1402 # 80020b40 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004126:	a1e48493          	addi	s1,s1,-1506 # 80020b40 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004144:	a30a8a93          	addi	s5,s5,-1488 # 80020b70 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004148:	0001da17          	auipc	s4,0x1d
    8000414c:	9f8a0a13          	addi	s4,s4,-1544 # 80020b40 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800041ce:	9a07a123          	sw	zero,-1630(a5) # 80020b6c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041ee:	95690913          	addi	s2,s2,-1706 # 80020b40 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000422c:	94870713          	addi	a4,a4,-1720 # 80020b70 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004248:	8fc78793          	addi	a5,a5,-1796 # 80020b40 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004260:	8e470713          	addi	a4,a4,-1820 # 80020b40 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004298:	8ac70713          	addi	a4,a4,-1876 # 80020b40 <log>
  ...
  release(&log.lock);
    ...
    800042aa:	89a50513          	addi	a0,a0,-1894 # 80020b40 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004400:	88c50513          	addi	a0,a0,-1908 # 80020c88 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    8000444e:	83e50513          	addi	a0,a0,-1986 # 80020c88 <ftable>
  ...
  return 0;
    ...
    80004466:	82650513          	addi	a0,a0,-2010 # 80020c88 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000448e:	7fe50513          	addi	a0,a0,2046 # 80020c88 <ftable>
  ...
  release(&ftable.lock);
    ...
    800044a8:	7e450513          	addi	a0,a0,2020 # 80020c88 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044e8:	7a450513          	addi	a0,a0,1956 # 80020c88 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004522:	76a50513          	addi	a0,a0,1898 # 80020c88 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    8000456c:	72050513          	addi	a0,a0,1824 # 80020c88 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000469e:	54e70713          	addi	a4,a4,1358 # 80020be8 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000473e:	4ae70713          	addi	a4,a4,1198 # 80020be8 <devsw>
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004f6e:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffdd340>
...
{    
    ...
    80005cb6:	f8e70713          	addi	a4,a4,-114 # 80021c40 <t>
...
{    
    ...
    80005d10:	f3448493          	addi	s1,s1,-204 # 80021c40 <t>
    ...
    if (t[sem]->value == 0){
    80005d28:	fdc42503          	lw	a0,-36(s0)
    80005d2c:	00351793          	slli	a5,a0,0x3
    80005d30:	94be                	add	s1,s1,a5
    80005d32:	609c                	ld	a5,0(s1)
    80005d34:	439c                	lw	a5,0(a5)
    80005d36:	cf8d                	beqz	a5,80005d70 <sys_sem_up+0x7c>
        wakeup(&t[sem]);
    }
    t[sem]->value = t[sem]->value + 1;
    80005d38:	0001c717          	auipc	a4,0x1c
    80005d3c:	f0870713          	addi	a4,a4,-248 # 80021c40 <t>
    80005d40:	fdc42783          	lw	a5,-36(s0)
    80005d44:	078e                	slli	a5,a5,0x3
    80005d46:	97ba                	add	a5,a5,a4
    80005d48:	6394                	ld	a3,0(a5)
    80005d4a:	429c                	lw	a5,0(a3)
    80005d4c:	2785                	addiw	a5,a5,1
    80005d4e:	c29c                	sw	a5,0(a3)
        
    //printf("segundo valor de value desp del up %d \n",t[sem]->value);
    release(&t[sem]->sl);
    80005d50:	fdc42783          	lw	a5,-36(s0)
    80005d54:	078e                	slli	a5,a5,0x3
    80005d56:	973e                	add	a4,a4,a5
    80005d58:	6308                	ld	a0,0(a4)
    80005d5a:	0521                	addi	a0,a0,8
    80005d5c:	ffffb097          	auipc	ra,0xffffb
    80005d60:	f42080e7          	jalr	-190(ra) # 80000c9e <release>
    return 1;
}
    80005d64:	4505                	li	a0,1
    80005d66:	70a2                	ld	ra,40(sp)
    80005d68:	7402                	ld	s0,32(sp)
    80005d6a:	64e2                	ld	s1,24(sp)
    80005d6c:	6145                	addi	sp,sp,48
    80005d6e:	8082                	ret
        wakeup(&t[sem]);
    80005d70:	8526                	mv	a0,s1
    80005d72:	ffffc097          	auipc	ra,0xffffc
    80005d76:	35c080e7          	jalr	860(ra) # 800020ce <wakeup>
    80005d7a:	bf7d                	j	80005d38 <sys_sem_up+0x44>

0000000080005d7c <sys_sem_down>:
...
sys_sem_down(void)
{
    ...
    int sem;
    argint(0,&sem);
    80005d86:	fdc40593          	addi	a1,s0,-36
    80005d8a:	4501                	li	a0,0
    80005d8c:	ffffd097          	auipc	ra,0xffffd
    80005d90:	d4a080e7          	jalr	-694(ra) # 80002ad6 <argint>
    acquire(&t[sem]->sl);
    80005d94:	0001c497          	auipc	s1,0x1c
    80005d98:	eac48493          	addi	s1,s1,-340 # 80021c40 <t>
    80005d9c:	fdc42783          	lw	a5,-36(s0)
    80005da0:	078e                	slli	a5,a5,0x3
    80005da2:	97a6                	add	a5,a5,s1
    80005da4:	6388                	ld	a0,0(a5)
    80005da6:	0521                	addi	a0,a0,8
    80005da8:	ffffb097          	auipc	ra,0xffffb
    80005dac:	e42080e7          	jalr	-446(ra) # 80000bea <acquire>
    //printf("primer valor de value anres del down %d \n",t[sem]->value);
    
    if (t[sem]->value == 0){
    80005db0:	fdc42503          	lw	a0,-36(s0)
    80005db4:	00351793          	slli	a5,a0,0x3
    80005db8:	94be                	add	s1,s1,a5
    80005dba:	608c                	ld	a1,0(s1)
    80005dbc:	419c                	lw	a5,0(a1)
    80005dbe:	cb85                	beqz	a5,80005dee <sys_sem_down+0x72>
        sleep(&t[sem],&t[sem]->sl);
    }
    else{
        t[sem]->value = t[sem]->value -1;
    80005dc0:	37fd                	addiw	a5,a5,-1
    80005dc2:	c19c                	sw	a5,0(a1)
    }
    //printf("segundo valor de value desp del down %d \n",t[sem]->value);
    release(&t[sem]->sl);
    80005dc4:	fdc42783          	lw	a5,-36(s0)
    80005dc8:	00379713          	slli	a4,a5,0x3
    80005dcc:	0001c797          	auipc	a5,0x1c
    80005dd0:	e7478793          	addi	a5,a5,-396 # 80021c40 <t>
    80005dd4:	97ba                	add	a5,a5,a4
    80005dd6:	6388                	ld	a0,0(a5)
    80005dd8:	0521                	addi	a0,a0,8
    80005dda:	ffffb097          	auipc	ra,0xffffb
    80005dde:	ec4080e7          	jalr	-316(ra) # 80000c9e <release>
    return 1;

}
    80005de2:	4505                	li	a0,1
    ...
    80005dec:	8082                	ret
        sleep(&t[sem],&t[sem]->sl);
    80005dee:	05a1                	addi	a1,a1,8
    80005df0:	8526                	mv	a0,s1
    80005df2:	ffffc097          	auipc	ra,0xffffc
    80005df6:	278080e7          	jalr	632(ra) # 8000206a <sleep>
    80005dfa:	b7e9                	j	80005dc4 <sys_sem_down+0x48>

0000000080005dfc <free_desc>:
}
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    80005e04:	479d                	li	a5,7
    80005e06:	04a7cc63          	blt	a5,a0,80005e5e <free_desc+0x62>
    panic("free_desc 1");
  if(disk.free[i])
    80005e0a:	0001c797          	auipc	a5,0x1c
    80005e0e:	e4678793          	addi	a5,a5,-442 # 80021c50 <disk>
    80005e12:	97aa                	add	a5,a5,a0
    80005e14:	0187c783          	lbu	a5,24(a5)
    80005e18:	ebb9                	bnez	a5,80005e6e <free_desc+0x72>
    panic("free_desc 2");
  disk.desc[i].addr = 0;
    80005e1a:	00451613          	slli	a2,a0,0x4
    80005e1e:	0001c797          	auipc	a5,0x1c
    80005e22:	e3278793          	addi	a5,a5,-462 # 80021c50 <disk>
    80005e26:	6394                	ld	a3,0(a5)
    80005e28:	96b2                	add	a3,a3,a2
    80005e2a:	0006b023          	sd	zero,0(a3)
  disk.desc[i].len = 0;
    80005e2e:	6398                	ld	a4,0(a5)
    80005e30:	9732                	add	a4,a4,a2
    80005e32:	00072423          	sw	zero,8(a4)
  disk.desc[i].flags = 0;
    80005e36:	00071623          	sh	zero,12(a4)
  disk.desc[i].next = 0;
    80005e3a:	00071723          	sh	zero,14(a4)
  disk.free[i] = 1;
    80005e3e:	953e                	add	a0,a0,a5
    80005e40:	4785                	li	a5,1
    80005e42:	00f50c23          	sb	a5,24(a0) # c201018 <_entry-0x73dfefe8>
  wakeup(&disk.free[0]);
    80005e46:	0001c517          	auipc	a0,0x1c
    80005e4a:	e2250513          	addi	a0,a0,-478 # 80021c68 <disk+0x18>
    80005e4e:	ffffc097          	auipc	ra,0xffffc
    80005e52:	280080e7          	jalr	640(ra) # 800020ce <wakeup>
}
    ...
    80005e62:	90250513          	addi	a0,a0,-1790 # 80008760 <syscalls+0x310>
    80005e66:	ffffa097          	auipc	ra,0xffffa
    80005e6a:	6de080e7          	jalr	1758(ra) # 80000544 <panic>
    panic("free_desc 2");
    80005e6e:	00003517          	auipc	a0,0x3
    80005e72:	90250513          	addi	a0,a0,-1790 # 80008770 <syscalls+0x320>
    80005e76:	ffffa097          	auipc	ra,0xffffa
    80005e7a:	6ce080e7          	jalr	1742(ra) # 80000544 <panic>

0000000080005e7e <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005e8e:	8f658593          	addi	a1,a1,-1802 # 80008780 <syscalls+0x330>
    80005e92:	0001c517          	auipc	a0,0x1c
    80005e96:	ee650513          	addi	a0,a0,-282 # 80021d78 <disk+0x128>
    80005e9a:	ffffb097          	auipc	ra,0xffffb
    80005e9e:	cc0080e7          	jalr	-832(ra) # 80000b5a <initlock>
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    80005ea2:	100017b7          	lui	a5,0x10001
    80005ea6:	4398                	lw	a4,0(a5)
    80005ea8:	2701                	sext.w	a4,a4
    80005eaa:	747277b7          	lui	a5,0x74727
    80005eae:	97678793          	addi	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
    80005eb2:	14f71e63          	bne	a4,a5,8000600e <virtio_disk_init+0x190>
     *R(VIRTIO_MMIO_VERSION) != 2 ||
    80005eb6:	100017b7          	lui	a5,0x10001
    80005eba:	43dc                	lw	a5,4(a5)
    80005ebc:	2781                	sext.w	a5,a5
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    80005ebe:	4709                	li	a4,2
    80005ec0:	14e79763          	bne	a5,a4,8000600e <virtio_disk_init+0x190>
     *R(VIRTIO_MMIO_DEVICE_ID) != 2 ||
    80005ec4:	100017b7          	lui	a5,0x10001
    80005ec8:	479c                	lw	a5,8(a5)
    80005eca:	2781                	sext.w	a5,a5
     *R(VIRTIO_MMIO_VERSION) != 2 ||
    80005ecc:	14e79163          	bne	a5,a4,8000600e <virtio_disk_init+0x190>
     *R(VIRTIO_MMIO_VENDOR_ID) != 0x554d4551){
    80005ed0:	100017b7          	lui	a5,0x10001
    80005ed4:	47d8                	lw	a4,12(a5)
    80005ed6:	2701                	sext.w	a4,a4
     *R(VIRTIO_MMIO_DEVICE_ID) != 2 ||
    80005ed8:	554d47b7          	lui	a5,0x554d4
    80005edc:	55178793          	addi	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
    80005ee0:	12f71763          	bne	a4,a5,8000600e <virtio_disk_init+0x190>
  *R(VIRTIO_MMIO_STATUS) = status;
    80005ee4:	100017b7          	lui	a5,0x10001
    80005ee8:	0607a823          	sw	zero,112(a5) # 10001070 <_entry-0x6fffef90>
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005efa:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc9cf>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  status = *R(VIRTIO_MMIO_STATUS);
    80005f08:	0707a903          	lw	s2,112(a5)
    80005f0c:	2901                	sext.w	s2,s2
  if(!(status & VIRTIO_CONFIG_S_FEATURES_OK))
    80005f0e:	00897793          	andi	a5,s2,8
    80005f12:	10078663          	beqz	a5,8000601e <virtio_disk_init+0x1a0>
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
    80005f16:	100017b7          	lui	a5,0x10001
    80005f1a:	0207a823          	sw	zero,48(a5) # 10001030 <_entry-0x6fffefd0>
  if(*R(VIRTIO_MMIO_QUEUE_READY))
    80005f1e:	43fc                	lw	a5,68(a5)
    80005f20:	2781                	sext.w	a5,a5
    80005f22:	10079663          	bnez	a5,8000602e <virtio_disk_init+0x1b0>
  uint32 max = *R(VIRTIO_MMIO_QUEUE_NUM_MAX);
    80005f26:	100017b7          	lui	a5,0x10001
    80005f2a:	5bdc                	lw	a5,52(a5)
    80005f2c:	2781                	sext.w	a5,a5
  if(max == 0)
    80005f2e:	10078863          	beqz	a5,8000603e <virtio_disk_init+0x1c0>
  if(max < NUM)
    80005f32:	471d                	li	a4,7
    80005f34:	10f77d63          	bgeu	a4,a5,8000604e <virtio_disk_init+0x1d0>
  disk.desc = kalloc();
    80005f38:	ffffb097          	auipc	ra,0xffffb
    80005f3c:	bc2080e7          	jalr	-1086(ra) # 80000afa <kalloc>
    80005f40:	0001c497          	auipc	s1,0x1c
    80005f44:	d1048493          	addi	s1,s1,-752 # 80021c50 <disk>
    80005f48:	e088                	sd	a0,0(s1)
  disk.avail = kalloc();
    80005f4a:	ffffb097          	auipc	ra,0xffffb
    80005f4e:	bb0080e7          	jalr	-1104(ra) # 80000afa <kalloc>
    80005f52:	e488                	sd	a0,8(s1)
  disk.used = kalloc();
    80005f54:	ffffb097          	auipc	ra,0xffffb
    80005f58:	ba6080e7          	jalr	-1114(ra) # 80000afa <kalloc>
    80005f5c:	87aa                	mv	a5,a0
    80005f5e:	e888                	sd	a0,16(s1)
  if(!disk.desc || !disk.avail || !disk.used)
    80005f60:	6088                	ld	a0,0(s1)
    80005f62:	cd75                	beqz	a0,8000605e <virtio_disk_init+0x1e0>
    80005f64:	0001c717          	auipc	a4,0x1c
    80005f68:	cf473703          	ld	a4,-780(a4) # 80021c58 <disk+0x8>
    80005f6c:	cb6d                	beqz	a4,8000605e <virtio_disk_init+0x1e0>
    80005f6e:	cbe5                	beqz	a5,8000605e <virtio_disk_init+0x1e0>
  ...
  memset(disk.avail, 0, PGSIZE);
    80005f7c:	0001c497          	auipc	s1,0x1c
    80005f80:	cd448493          	addi	s1,s1,-812 # 80021c50 <disk>
    80005f84:	6605                	lui	a2,0x1
    80005f86:	4581                	li	a1,0
    80005f88:	6488                	ld	a0,8(s1)
    80005f8a:	ffffb097          	auipc	ra,0xffffb
    80005f8e:	d5c080e7          	jalr	-676(ra) # 80000ce6 <memset>
  memset(disk.used, 0, PGSIZE);
    80005f92:	6605                	lui	a2,0x1
    80005f94:	4581                	li	a1,0
    80005f96:	6888                	ld	a0,16(s1)
    80005f98:	ffffb097          	auipc	ra,0xffffb
    80005f9c:	d4e080e7          	jalr	-690(ra) # 80000ce6 <memset>
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
    80005fa0:	100017b7          	lui	a5,0x10001
    80005fa4:	4721                	li	a4,8
    80005fa6:	df98                	sw	a4,56(a5)
  *R(VIRTIO_MMIO_QUEUE_DESC_LOW) = (uint64)disk.desc;
    80005fa8:	4098                	lw	a4,0(s1)
    80005faa:	08e7a023          	sw	a4,128(a5) # 10001080 <_entry-0x6fffef80>
  *R(VIRTIO_MMIO_QUEUE_DESC_HIGH) = (uint64)disk.desc >> 32;
    80005fae:	40d8                	lw	a4,4(s1)
    80005fb0:	08e7a223          	sw	a4,132(a5)
  *R(VIRTIO_MMIO_DRIVER_DESC_LOW) = (uint64)disk.avail;
    80005fb4:	6498                	ld	a4,8(s1)
    80005fb6:	0007069b          	sext.w	a3,a4
    80005fba:	08d7a823          	sw	a3,144(a5)
  *R(VIRTIO_MMIO_DRIVER_DESC_HIGH) = (uint64)disk.avail >> 32;
    80005fbe:	9701                	srai	a4,a4,0x20
    80005fc0:	08e7aa23          	sw	a4,148(a5)
  *R(VIRTIO_MMIO_DEVICE_DESC_LOW) = (uint64)disk.used;
    80005fc4:	6898                	ld	a4,16(s1)
    80005fc6:	0007069b          	sext.w	a3,a4
    80005fca:	0ad7a023          	sw	a3,160(a5)
  *R(VIRTIO_MMIO_DEVICE_DESC_HIGH) = (uint64)disk.used >> 32;
    80005fce:	9701                	srai	a4,a4,0x20
    80005fd0:	0ae7a223          	sw	a4,164(a5)
  *R(VIRTIO_MMIO_QUEUE_READY) = 0x1;
    80005fd4:	4685                	li	a3,1
    80005fd6:	c3f4                	sw	a3,68(a5)
    disk.free[i] = 1;
    80005fd8:	4705                	li	a4,1
    80005fda:	00d48c23          	sb	a3,24(s1)
    80005fde:	00e48ca3          	sb	a4,25(s1)
    80005fe2:	00e48d23          	sb	a4,26(s1)
    80005fe6:	00e48da3          	sb	a4,27(s1)
    80005fea:	00e48e23          	sb	a4,28(s1)
    80005fee:	00e48ea3          	sb	a4,29(s1)
    80005ff2:	00e48f23          	sb	a4,30(s1)
    80005ff6:	00e48fa3          	sb	a4,31(s1)
  status |= VIRTIO_CONFIG_S_DRIVER_OK;
    80005ffa:	00496913          	ori	s2,s2,4
  *R(VIRTIO_MMIO_STATUS) = status;
    80005ffe:	0727a823          	sw	s2,112(a5)
}
    ...
    80006012:	78250513          	addi	a0,a0,1922 # 80008790 <syscalls+0x340>
    80006016:	ffffa097          	auipc	ra,0xffffa
    8000601a:	52e080e7          	jalr	1326(ra) # 80000544 <panic>
    panic("virtio disk FEATURES_OK unset");
    8000601e:	00002517          	auipc	a0,0x2
    80006022:	79250513          	addi	a0,a0,1938 # 800087b0 <syscalls+0x360>
    80006026:	ffffa097          	auipc	ra,0xffffa
    8000602a:	51e080e7          	jalr	1310(ra) # 80000544 <panic>
    panic("virtio disk should not be ready");
    8000602e:	00002517          	auipc	a0,0x2
    80006032:	7a250513          	addi	a0,a0,1954 # 800087d0 <syscalls+0x380>
    80006036:	ffffa097          	auipc	ra,0xffffa
    8000603a:	50e080e7          	jalr	1294(ra) # 80000544 <panic>
    panic("virtio disk has no queue 0");
    8000603e:	00002517          	auipc	a0,0x2
    80006042:	7b250513          	addi	a0,a0,1970 # 800087f0 <syscalls+0x3a0>
    80006046:	ffffa097          	auipc	ra,0xffffa
    8000604a:	4fe080e7          	jalr	1278(ra) # 80000544 <panic>
    panic("virtio disk max queue too short");
    8000604e:	00002517          	auipc	a0,0x2
    80006052:	7c250513          	addi	a0,a0,1986 # 80008810 <syscalls+0x3c0>
    80006056:	ffffa097          	auipc	ra,0xffffa
    8000605a:	4ee080e7          	jalr	1262(ra) # 80000544 <panic>
    panic("virtio disk kalloc");
    8000605e:	00002517          	auipc	a0,0x2
    80006062:	7d250513          	addi	a0,a0,2002 # 80008830 <syscalls+0x3e0>
    80006066:	ffffa097          	auipc	ra,0xffffa
    8000606a:	4de080e7          	jalr	1246(ra) # 80000544 <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
    ...
    80006084:	ec66                	sd	s9,24(sp)
    80006086:	e86a                	sd	s10,16(sp)
    80006088:	1880                	addi	s0,sp,112
    8000608a:	892a                	mv	s2,a0
    8000608c:	8d2e                	mv	s10,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    8000608e:	00c52c83          	lw	s9,12(a0)
    80006092:	001c9c9b          	slliw	s9,s9,0x1
    80006096:	1c82                	slli	s9,s9,0x20
    80006098:	020cdc93          	srli	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    8000609c:	0001c517          	auipc	a0,0x1c
    800060a0:	cdc50513          	addi	a0,a0,-804 # 80021d78 <disk+0x128>
    800060a4:	ffffb097          	auipc	ra,0xffffb
    800060a8:	b46080e7          	jalr	-1210(ra) # 80000bea <acquire>
  for(int i = 0; i < 3; i++){
    800060ac:	4981                	li	s3,0
  for(int i = 0; i < NUM; i++){
    800060ae:	4ba1                	li	s7,8
      disk.free[i] = 0;
    800060b0:	0001cb17          	auipc	s6,0x1c
    800060b4:	ba0b0b13          	addi	s6,s6,-1120 # 80021c50 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800060bc:	0001cc17          	auipc	s8,0x1c
    800060c0:	cbcc0c13          	addi	s8,s8,-836 # 80021d78 <disk+0x128>
    800060c4:	a8b5                	j	80006140 <virtio_disk_rw+0xd2>
      disk.free[i] = 0;
    800060c6:	00fb06b3          	add	a3,s6,a5
    800060ca:	00068c23          	sb	zero,24(a3)
    idx[i] = alloc_desc();
    800060ce:	c21c                	sw	a5,0(a2)
    if(idx[i] < 0){
    800060d0:	0207c563          	bltz	a5,800060fa <virtio_disk_rw+0x8c>
  for(int i = 0; i < 3; i++){
    800060d4:	2485                	addiw	s1,s1,1
    800060d6:	0711                	addi	a4,a4,4
    800060d8:	1f548a63          	beq	s1,s5,800062cc <virtio_disk_rw+0x25e>
    idx[i] = alloc_desc();
    800060dc:	863a                	mv	a2,a4
  for(int i = 0; i < NUM; i++){
    800060de:	0001c697          	auipc	a3,0x1c
    800060e2:	b7268693          	addi	a3,a3,-1166 # 80021c50 <disk>
    800060e6:	87d2                	mv	a5,s4
    if(disk.free[i]){
    800060e8:	0186c583          	lbu	a1,24(a3)
    800060ec:	fde9                	bnez	a1,800060c6 <virtio_disk_rw+0x58>
  for(int i = 0; i < NUM; i++){
    800060ee:	2785                	addiw	a5,a5,1
    800060f0:	0685                	addi	a3,a3,1
    800060f2:	ff779be3          	bne	a5,s7,800060e8 <virtio_disk_rw+0x7a>
    idx[i] = alloc_desc();
    800060f6:	57fd                	li	a5,-1
    800060f8:	c21c                	sw	a5,0(a2)
      for(int j = 0; j < i; j++)
    800060fa:	02905a63          	blez	s1,8000612e <virtio_disk_rw+0xc0>
        free_desc(idx[j]);
    800060fe:	f9042503          	lw	a0,-112(s0)
    80006102:	00000097          	auipc	ra,0x0
    80006106:	cfa080e7          	jalr	-774(ra) # 80005dfc <free_desc>
      for(int j = 0; j < i; j++)
    8000610a:	4785                	li	a5,1
    8000610c:	0297d163          	bge	a5,s1,8000612e <virtio_disk_rw+0xc0>
        free_desc(idx[j]);
    80006110:	f9442503          	lw	a0,-108(s0)
    80006114:	00000097          	auipc	ra,0x0
    80006118:	ce8080e7          	jalr	-792(ra) # 80005dfc <free_desc>
      for(int j = 0; j < i; j++)
    8000611c:	4789                	li	a5,2
    8000611e:	0097d863          	bge	a5,s1,8000612e <virtio_disk_rw+0xc0>
        free_desc(idx[j]);
    80006122:	f9842503          	lw	a0,-104(s0)
    80006126:	00000097          	auipc	ra,0x0
    8000612a:	cd6080e7          	jalr	-810(ra) # 80005dfc <free_desc>
    sleep(&disk.free[0], &disk.vdisk_lock);
    8000612e:	85e2                	mv	a1,s8
    80006130:	0001c517          	auipc	a0,0x1c
    80006134:	b3850513          	addi	a0,a0,-1224 # 80021c68 <disk+0x18>
    80006138:	ffffc097          	auipc	ra,0xffffc
    8000613c:	f32080e7          	jalr	-206(ra) # 8000206a <sleep>
  for(int i = 0; i < 3; i++){
    80006140:	f9040713          	addi	a4,s0,-112
    80006144:	84ce                	mv	s1,s3
    80006146:	bf59                	j	800060dc <virtio_disk_rw+0x6e>
  ...
  if(write)
    ...
    80006148:	00a60793          	addi	a5,a2,10 # 100a <_entry-0x7fffeff6>
    8000614c:	00479693          	slli	a3,a5,0x4
    80006150:	0001c797          	auipc	a5,0x1c
    80006154:	b0078793          	addi	a5,a5,-1280 # 80021c50 <disk>
  ...
  buf0->reserved = 0;
    8000615e:	0001c597          	auipc	a1,0x1c
    80006162:	af258593          	addi	a1,a1,-1294 # 80021c50 <disk>
    80006166:	00a60793          	addi	a5,a2,10
    8000616a:	0792                	slli	a5,a5,0x4
    8000616c:	97ae                	add	a5,a5,a1
    8000616e:	0007a623          	sw	zero,12(a5)
  buf0->sector = sector;
    80006172:	0197b823          	sd	s9,16(a5)

  disk.desc[idx[0]].addr = (uint64) buf0;
    80006176:	f6070693          	addi	a3,a4,-160
    8000617a:	619c                	ld	a5,0(a1)
    8000617c:	97b6                	add	a5,a5,a3
    8000617e:	e388                	sd	a0,0(a5)
  disk.desc[idx[0]].len = sizeof(struct virtio_blk_req);
    80006180:	6188                	ld	a0,0(a1)
    80006182:	96aa                	add	a3,a3,a0
    80006184:	47c1                	li	a5,16
    80006186:	c69c                	sw	a5,8(a3)
  disk.desc[idx[0]].flags = VRING_DESC_F_NEXT;
    80006188:	4785                	li	a5,1
    8000618a:	00f69623          	sh	a5,12(a3)
  disk.desc[idx[0]].next = idx[1];
    8000618e:	f9442783          	lw	a5,-108(s0)
    80006192:	00f69723          	sh	a5,14(a3)

  disk.desc[idx[1]].addr = (uint64) b->data;
    80006196:	0792                	slli	a5,a5,0x4
    80006198:	953e                	add	a0,a0,a5
    8000619a:	05890693          	addi	a3,s2,88
    8000619e:	e114                	sd	a3,0(a0)
  disk.desc[idx[1]].len = BSIZE;
    800061a0:	6188                	ld	a0,0(a1)
    800061a2:	97aa                	add	a5,a5,a0
    800061a4:	40000693          	li	a3,1024
    800061a8:	c794                	sw	a3,8(a5)
  if(write)
    800061aa:	100d0d63          	beqz	s10,800062c4 <virtio_disk_rw+0x256>
    disk.desc[idx[1]].flags = 0; // device reads b->data
    800061ae:	00079623          	sh	zero,12(a5)
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    800061b2:	00c7d683          	lhu	a3,12(a5)
    800061b6:	0016e693          	ori	a3,a3,1
    800061ba:	00d79623          	sh	a3,12(a5)
  disk.desc[idx[1]].next = idx[2];
    800061be:	f9842583          	lw	a1,-104(s0)
    800061c2:	00b79723          	sh	a1,14(a5)

  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    800061c6:	0001c697          	auipc	a3,0x1c
    800061ca:	a8a68693          	addi	a3,a3,-1398 # 80021c50 <disk>
    800061ce:	00260793          	addi	a5,a2,2
    800061d2:	0792                	slli	a5,a5,0x4
    800061d4:	97b6                	add	a5,a5,a3
    800061d6:	587d                	li	a6,-1
    800061d8:	01078823          	sb	a6,16(a5)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    800061dc:	0592                	slli	a1,a1,0x4
    800061de:	952e                	add	a0,a0,a1
    800061e0:	f9070713          	addi	a4,a4,-112
    800061e4:	9736                	add	a4,a4,a3
    800061e6:	e118                	sd	a4,0(a0)
  disk.desc[idx[2]].len = 1;
    800061e8:	6298                	ld	a4,0(a3)
    800061ea:	972e                	add	a4,a4,a1
    800061ec:	4585                	li	a1,1
    800061ee:	c70c                	sw	a1,8(a4)
  disk.desc[idx[2]].flags = VRING_DESC_F_WRITE; // device writes the status
    800061f0:	4509                	li	a0,2
    800061f2:	00a71623          	sh	a0,12(a4)
  disk.desc[idx[2]].next = 0;
    800061f6:	00071723          	sh	zero,14(a4)

  // record struct buf for virtio_disk_intr().
  b->disk = 1;
    800061fa:	00b92223          	sw	a1,4(s2)
  disk.info[idx[0]].b = b;
    800061fe:	0127b423          	sd	s2,8(a5)
  ...
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    ...
    8000620a:	0786                	slli	a5,a5,0x1
    8000620c:	97ba                	add	a5,a5,a4
    8000620e:	00c79223          	sh	a2,4(a5)
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    8000622e:	00492703          	lw	a4,4(s2)
    80006232:	4785                	li	a5,1
    80006234:	02f71163          	bne	a4,a5,80006256 <virtio_disk_rw+0x1e8>
    sleep(b, &disk.vdisk_lock);
    80006238:	0001c997          	auipc	s3,0x1c
    8000623c:	b4098993          	addi	s3,s3,-1216 # 80021d78 <disk+0x128>
  while(b->disk == 1) {
    80006240:	4485                	li	s1,1
    sleep(b, &disk.vdisk_lock);
    80006242:	85ce                	mv	a1,s3
    80006244:	854a                	mv	a0,s2
    80006246:	ffffc097          	auipc	ra,0xffffc
    8000624a:	e24080e7          	jalr	-476(ra) # 8000206a <sleep>
  while(b->disk == 1) {
    8000624e:	00492783          	lw	a5,4(s2)
    80006252:	fe9788e3          	beq	a5,s1,80006242 <virtio_disk_rw+0x1d4>
  }

  disk.info[idx[0]].b = 0;
    80006256:	f9042903          	lw	s2,-112(s0)
    8000625a:	00290793          	addi	a5,s2,2
    8000625e:	00479713          	slli	a4,a5,0x4
    80006262:	0001c797          	auipc	a5,0x1c
    80006266:	9ee78793          	addi	a5,a5,-1554 # 80021c50 <disk>
    8000626a:	97ba                	add	a5,a5,a4
    8000626c:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80006270:	0001c997          	auipc	s3,0x1c
    80006274:	9e098993          	addi	s3,s3,-1568 # 80021c50 <disk>
    ...
    80006290:	b70080e7          	jalr	-1168(ra) # 80005dfc <free_desc>
    if(flag & VRING_DESC_F_NEXT)
    80006294:	8885                	andi	s1,s1,1
    80006296:	f0ed                	bnez	s1,80006278 <virtio_disk_rw+0x20a>
  free_chain(idx[0]);

  release(&disk.vdisk_lock);
    80006298:	0001c517          	auipc	a0,0x1c
    8000629c:	ae050513          	addi	a0,a0,-1312 # 80021d78 <disk+0x128>
    800062a0:	ffffb097          	auipc	ra,0xffffb
    800062a4:	9fe080e7          	jalr	-1538(ra) # 80000c9e <release>
}
    800062a8:	70a6                	ld	ra,104(sp)
    800062aa:	7406                	ld	s0,96(sp)
    800062ac:	64e6                	ld	s1,88(sp)
    800062ae:	6946                	ld	s2,80(sp)
    800062b0:	69a6                	ld	s3,72(sp)
    800062b2:	6a06                	ld	s4,64(sp)
    800062b4:	7ae2                	ld	s5,56(sp)
    800062b6:	7b42                	ld	s6,48(sp)
    800062b8:	7ba2                	ld	s7,40(sp)
    800062ba:	7c02                	ld	s8,32(sp)
    800062bc:	6ce2                	ld	s9,24(sp)
    800062be:	6d42                	ld	s10,16(sp)
    800062c0:	6165                	addi	sp,sp,112
    800062c2:	8082                	ret
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
    800062c4:	4689                	li	a3,2
    800062c6:	00d79623          	sh	a3,12(a5)
    800062ca:	b5e5                	j	800061b2 <virtio_disk_rw+0x144>
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    800062cc:	f9042603          	lw	a2,-112(s0)
    800062d0:	00a60713          	addi	a4,a2,10
    800062d4:	0712                	slli	a4,a4,0x4
    800062d6:	0001c517          	auipc	a0,0x1c
    800062da:	98250513          	addi	a0,a0,-1662 # 80021c58 <disk+0x8>
    800062de:	953a                	add	a0,a0,a4
  if(write)
    800062e0:	e60d14e3          	bnez	s10,80006148 <virtio_disk_rw+0xda>
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
    800062e4:	00a60793          	addi	a5,a2,10
    800062e8:	00479693          	slli	a3,a5,0x4
    800062ec:	0001c797          	auipc	a5,0x1c
    800062f0:	96478793          	addi	a5,a5,-1692 # 80021c50 <disk>
    800062f4:	97b6                	add	a5,a5,a3
    800062f6:	0007a423          	sw	zero,8(a5)
    800062fa:	b595                	j	8000615e <virtio_disk_rw+0xf0>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000630a:	94a48493          	addi	s1,s1,-1718 # 80021c50 <disk>
    8000630e:	0001c517          	auipc	a0,0x1c
    80006312:	a6a50513          	addi	a0,a0,-1430 # 80021d78 <disk+0x128>
    80006316:	ffffb097          	auipc	ra,0xffffb
    8000631a:	8d4080e7          	jalr	-1836(ra) # 80000bea <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    8000632c:	689c                	ld	a5,16(s1)
    8000632e:	0204d703          	lhu	a4,32(s1)
    80006332:	0027d783          	lhu	a5,2(a5)
    80006336:	04f70863          	beq	a4,a5,80006386 <virtio_disk_intr+0x8a>
    __sync_synchronize();
    8000633a:	0ff0000f          	fence
    int id = disk.used->ring[disk.used_idx % NUM].id;
    8000633e:	6898                	ld	a4,16(s1)
    80006340:	0204d783          	lhu	a5,32(s1)
    80006344:	8b9d                	andi	a5,a5,7
    80006346:	078e                	slli	a5,a5,0x3
    80006348:	97ba                	add	a5,a5,a4
    8000634a:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    8000634c:	00278713          	addi	a4,a5,2
    80006350:	0712                	slli	a4,a4,0x4
    80006352:	9726                	add	a4,a4,s1
    80006354:	01074703          	lbu	a4,16(a4) # 10001010 <_entry-0x6fffeff0>
    80006358:	e721                	bnez	a4,800063a0 <virtio_disk_intr+0xa4>
      panic("virtio_disk_intr status");

    struct buf *b = disk.info[id].b;
    8000635a:	0789                	addi	a5,a5,2
    8000635c:	0792                	slli	a5,a5,0x4
    8000635e:	97a6                	add	a5,a5,s1
    80006360:	6788                	ld	a0,8(a5)
    b->disk = 0;   // disk is done with buf
    80006362:	00052223          	sw	zero,4(a0)
    wakeup(b);
    80006366:	ffffc097          	auipc	ra,0xffffc
    8000636a:	d68080e7          	jalr	-664(ra) # 800020ce <wakeup>
    ...
    80006378:	02f49023          	sh	a5,32(s1)
  while(disk.used_idx != disk.used->idx){
    8000637c:	6898                	ld	a4,16(s1)
    8000637e:	00275703          	lhu	a4,2(a4)
    80006382:	faf71ce3          	bne	a4,a5,8000633a <virtio_disk_intr+0x3e>
  }

  release(&disk.vdisk_lock);
    80006386:	0001c517          	auipc	a0,0x1c
    8000638a:	9f250513          	addi	a0,a0,-1550 # 80021d78 <disk+0x128>
    8000638e:	ffffb097          	auipc	ra,0xffffb
    80006392:	910080e7          	jalr	-1776(ra) # 80000c9e <release>
}
    ...
    800063a4:	4a850513          	addi	a0,a0,1192 # 80008848 <syscalls+0x3f8>
    800063a8:	ffffa097          	auipc	ra,0xffffa
    800063ac:	19c080e7          	jalr	412(ra) # 80000544 <panic>
	...
